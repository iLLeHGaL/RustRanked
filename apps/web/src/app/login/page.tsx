    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <Link href="/" className="mb-8 flex items-center justify-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-rust-600">
            <span className="text-xl font-bold text-white">R</span>
          </div>
          <span className="text-2xl font-bold text-white">RustRanked</span>
        </Link>
        ...
        <div className="card">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#5865F2] px-4 py-3 text-white transition-colors hover:bg-[#4752C4]"
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-zinc-500">
            New to RustRanked? Signing in will create an account.
          </p>
        </div>
      </div>
    </div>
